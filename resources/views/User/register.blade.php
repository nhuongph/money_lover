...
<div class="col-md-8 bg-white padding-top-bot col-md-offset-1">
    ...
    <h1 class="text-center">{{trans('money_lover.user_register')}}</h1>
    <div class="col-md-8 col-md-offset-2 padding-top-bot">
        ...
        <div class="card card-container">
            ...
            <div class="form-group">            
                ...
                {!! Form::text('email', null, ['class' => 'form-control','placeholder'=>Lang::get('money_lover.user_email')]) !!}
            </div>
            <div class="form-group">            
            ...
            {!! Form::submit(Lang::get('money_lover.user_register'),['class' => 'btn btn-success']) !!}
            {!! Form::close() !!}<!-- /form -->
        </div><!-- /card-container -->
        <!-- Start Carousel Section -->
    </div>
